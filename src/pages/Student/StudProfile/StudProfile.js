                  ...
                  <Grid item container xs={12}>
                    ...
                    >
                      <Typography
                        ...
                        color="#fff"
                      >
                        Not filling every field of the profile may result in disqualification
                      </Typography>
                    </div>
                      ...
                      <Grid container spacing={3}>
                        ...
                        <Grid item xs={6}>
                          <TextField
                            ...
                            onChange={handleProfileChange}
                            error={errorContact}
                            helperText={errorContact ? "Invalid number" : ""}
                          />
                        </Grid>
                        <Grid item xs={6}>
                          <TextField
                            ...
                            color="#fff"
                            background="#fff"
                            value={studData.registrationNumber}
                            onChange={handleProfileChange}
                          />
                        </Grid>
                        <Grid item xs={12}>
