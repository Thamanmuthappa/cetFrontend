...
const AllDomains = () => {
  ...
  const columns = [
    ...
    // { field: 'website', headerName: 'Website', flex: 1, },
    {
      field: 'website',
      headerName: 'Website',
      description: 'This column has either social or website links for the organisations.',
      sortable: true,
      flex: 1,
      renderCell: (params) => {
        return (<a href={params.getValue("website")} target="_blank">{params.getValue("website")}</a>)
      }
    },
  ];
  ...
  const rows =
    [
      ...
      },
      {
        ...
        subcategory: "",
        name: "FILM SOCIETY",
        website: "https://www.instagram.com/vitfilmsociety/?igshid=mfnkk4a3fath&hl=en",
        id: 5
      },
      {
        category: "ARTS&CULTURAL",
      ...
      },
      {
        ...
        subcategory: "",
        name: "HERITAGE CLUB",
        website: "https://www.instagram.com/heritageclubvit/?igshid=s1xr42lbh2kc&hl=en",
        id: 15
      },
      {
        category: "ARTS&CULTURAL",
      ...
      },
      {
        ...
        subcategory: "",
        name: "SPIC MACAY",
        website: "https://www.facebook.com/pages/category/Performance-Art/Spic-Macay-Vit-Chapter-668403383317525/",
        id: 17
      },
      {
        category: "ARTS&CULTURAL",
      ...
      },
      {
        ...
        subcategory: "",
        name: "ROTARACT CLUB",
        website: "https://www.instagram.com/rotaract_club_of_vit/p/BnRXrSPFtc_/?hl=en",
        id: 58
      },
      {
        category: "SOCIAL OUTREACH",
      ...
      },
      {
        ...
        website: "https://in.linkedin.com/company/smile-over-stress-sos-vit",
        id: 64
      },
      {
        category: "HEALTH & WELLNESS",
      ...
      },
      {
        ...
        website: "https://www.instagram.com/sahiti_tla/?igshid=17lrir8v58h0j",
        id: 88
      },
      {
        category: "LITERATURE",
    ...
    return (
      <div>
        ...
        <Container style={{ marginBottom: "40px" }}>
          ...
          <Divider />
          <div style={{ height: 700, width: '100%', marginTop: "40px", marginBottom: "40px" }}>
            <DataGrid rows={rows} columns={columns} pageSize={20} checkboxSelection={false} disableSelectionOnClick={true} />
          </div>
        </Container>
