                        ...
                        <Card className={
                            ...
                            <Grid item
                                ...
                                <TextField name="password" label="Password *" variant="outlined" type="password"
                                    ...
                                    helperText={
                                        ( errors.password ?. type === "required" && "Password is required" ) || ( errors.password ?. type === "minLength" && "Password should be at least 8 characters long!" )
                                    }
                                    className="form-input"/>
                            </Grid>
                        <Grid item
                            xs={6}>
                            <TextField name="rpassword" label="Retype Password *" variant="outlined" type="password"
                                inputRef={
                                    register( {
                                ...
                                helperText={
                                    errors.rpassword && "The passwords do not match"
                                }/>
                        </Grid>
                        <Grid item
                            xs={6}>
                            <TextField name="type" select
                                value={type}
                                onChange={
                                    ( e ) => {
...
</DialogActions></Dialog><Snackbar open={snackopen}
...
<p>Account Sucessfully Created</p></Snackbar><Grid item
    xs={6}
    style={
        { textAlign: "center" }
}>
<img src="/assets/celebration.jpg" alt="" height="auto"/></Grid></Grid></div>
    );
};
